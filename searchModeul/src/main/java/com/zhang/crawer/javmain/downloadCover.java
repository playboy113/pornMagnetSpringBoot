...
public class downloadCover {
    public void download_cover(String url) throws IOException, URISyntaxException {
        downloadCover.Builder builder = new downloadCover.Builder();
        setHeader.setUp();
