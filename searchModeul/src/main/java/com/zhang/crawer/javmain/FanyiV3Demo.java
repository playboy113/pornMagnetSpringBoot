...
public class FanyiV3Demo {
    ...
    private static final String APP_KEY = "369c8d0cf2180777";

    private static final String APP_SECRET = "bzDXb4pMhGMg427qOsfWkIlAbyFmBezZ";

    public  String tranStr(String str) throws IOException {
