...
public Map<String,Object> crawerBooks(String magnetUrl,Integer pages,Integer stop) throws IOException, URISyntaxException {
    ...
    //刷新下载全部图片
    @RequestMapping("/downloadCover.do")
    @ResponseBody
    public Map<String,Object> downloadcover(String magnetUrl,Integer pages,Integer stop) throws IOException, URISyntaxException {
        ...
        if (magnetUrl.contains("topicsbt_")) {
            ...
            for (int i =pages;i<stop;i++){
                ...
                downloadCover downloadCover = new downloadCover();

                System.out.println("正在下載第"+begin+i+".htm");

                downloadCover.download_cover(begin+i+".htm");
                //MySqlControl.executeInsert(javdb);
            }
